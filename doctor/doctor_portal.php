...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="../receptionist/css/bootstrap.css" />
  ...
  <link href="../receptionist/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="../receptionist/css/responsive.css" rel="stylesheet" />
...
<body>
  ...
  <div class="hero_area">
        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="index.html">
              <img src="..\receptionist\images\logo (2).png" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav  ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="doctor_appointments.php">My Appointments</a>
                  </li>
    ...
    <section class="slider_section ">
      <div class="dot_design">
        <img src="../receptionist/images/dots.png" alt="">
      </div>
          ...
          <div class="carousel-item active">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="../receptionist/images/slider-img.jpg" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <!-- custom js -->
  <script src="../receptionist/js/custom.js"></script>
